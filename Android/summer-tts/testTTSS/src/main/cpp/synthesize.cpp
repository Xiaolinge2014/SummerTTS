...
#include "include/SynthesizerTrn.h"
#include <cstring>
#include <jni.h>
#include <string>
#include <iostream>
...
Java_com_xiaolinge_chinese_1tts_utils_ChineseTTSUtils_synthesize(JNIEnv *env, jclass clazz, jstring text, jstring model_path) {
